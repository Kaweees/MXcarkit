...
class LineFollower(Node):
    def __init__(self, model_path, config_path):
        ...
        self.not_found_msg.pose.position.x = self.not_found_msg.pose.position.y = (
            self.not_found_msg.pose.position.z
        ) = float("nan")
        ...
        self.way_publisher = self.create_publisher(
    ...
    def image_callback(self, msg):
        ...
        image, timestamp_unix = image_to_np(
            msg
        ...
        success, line_mask = parse_predictions(
            predictions, class_ids=self.center_line_id
        )
